---
title: "Gabarit PDF"
author: "Davud Beauchemin et Samuel Lévesque"
date: "17 mars 2017"
output:
  pdf_document:
    fig_caption: yes
...
Il est possible d'aligner certains caractères (= par exemple) dans l'environnement *aligned*. Pour changer de ligne, on utilise la commande **\\**
