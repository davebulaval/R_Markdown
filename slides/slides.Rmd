...
### Markdown
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_Markdown_logo.png)

### R Markdown

![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_RMarkdownReference.png)
...
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_source_Markdown.jpg)

## Exemples d'utilisation de Markdown

### Stack Overflow
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_stack_overflow.jpg)

## Exemples d'utilisation de Markdown

### Stack Overflow

![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_stack_overflow_source.jpg)

## Exemples d'utilisation de Markdown

### Stack Exchange
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_stack_exchange.jpg)

## Exemples d'utilisation de Markdown

### Stack Exchange
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_stack_exchange_source.jpg)
...
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_TP_intro_II.JPG)
...
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_3_panneaux_Rmarkdown_flowchart.jpg)
...
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_RMarkdown_formats.jpg)
...
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_balises.jpg)
...
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_options_affichage.jpg)

## R Markdown

Extrait du travail pratique

![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_TP_intro_II_rapport.jpg)

## R Markdown

Solution : simplement en affichant le data.frame

![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_3_panneaux_solution_TP.jpg)
$\qquad \qquad \quad$ ![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_RMarkdownFlow.png)
...
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images\img_solution_exercice_3.jpg)
...
![](https://rawgit.com/davebulaval/R_Markdown/gh-pages/images/img_enonce_exercice_5_HTML_3.jpg)
